...
def upgrade() -> None:
    ...
    op.add_column('charge_points', sa.Column('latitude', sa.Numeric(), nullable=False))
    op.add_column('charge_points', sa.Column('longitude', sa.Numeric(), nullable=False))
    op.add_column('charge_points', sa.Column('serial_number', sa.String(), nullable=False))
    op.add_column('charge_points', sa.Column('unavailability_reason', sa.String(), nullable=False))
    op.add_column('charge_points', sa.Column('comment', sa.String(), nullable=False))
